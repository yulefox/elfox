...
static void platform_msdk_on_auth(const plat_base_req *req);
...
static int platform_qq_auth(const char *param, auth_cb cb, void *args)
{
...
static int platform_weixin_auth(const char *param, auth_cb cb, void *args)
{
